...
(function (global, factory) {
	...
	*/
	...
	var helpers_options = {
		 ...
		 * is called with `context` as first argument and the result becomes the new inputs.
		 * @param {number} [index] - If defined and the current value is an array, the value
		 * at `index` become the new inputs.
		 * @param {object} [info] - object to return inputs about resolution in
	...
	helpers$1.extend(DateAdapter.prototype, /** @lends DateAdapter */ {
		 ...
		 * @param {number} timestamp - the inputs timestamp
		 ...
		 * @param {number} max - the inputs timestamp (reference)
	...
	var defaultConfig$4 = {
		...
		ticks: {
			...
			/**
			 * Ticks generation inputs values:
