                                    ...
                                    @foreach($roles as $role)
                                        <div class="form-check checkbox mt-3">
                                            <?php
                                                ...
                                                if($flag === true){
                                                    echo '<inputs class="form-check-inputs" type="checkbox" value="true" name="_role_' . $role . '" checked>';
                                                    echo '<label class="form-check-label">' . $role . '</label>';
                                                }else{
                                                    echo '<inputs class="form-check-inputs" type="checkbox" value="true" name="_role_' . $role . '">';
                                                    echo '<label class="form-check-label">' . $role . '</label>';
                                                }
                                            ?>
                                        </div>
