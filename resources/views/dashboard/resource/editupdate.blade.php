                        ...
                        <form method="POST" action="{{ route('resource.update', ['table' => $form->id, 'resource' => $id ] ) }}" enctype="multipart/form-data">
                            ...
                            @foreach($columns as $column)
                                <?php
                                    ...
                                    $flag = false;
                                    foreach($inputOptions as $option){  //check did $column is inputs type
                                    ...
                                    if($flag == true){
                                        if($column['type'] == 'checkbox'){
                                            ...
                                            echo '<inputs class="form-check-inputs" type="checkbox" value="true" name="' . $column['column_name'] . '"';
                                            ...
                                            echo '<inputs class="form-check-inputs" type="radio" value="true" name="' . $column['column_name'] . '"';
                                            if($column['value'] == 'true'){
                                                echo ' checked ';
                                            }
                                            echo '>';
                                            ...
                                            echo '<inputs class="form-check-inputs" type="radio" value="false" name="' . $column['column_name'] . '"';
                                            ...
                                            echo '<inputs type="' . $column['type'] . '" class="form-control" name="' . $column['column_name'] . '" value="' . $column['value'] .'">';
                                        }
                                        ...
                                        foreach($relations['relation_' . $column['column_name']] as $relation){
                                            echo '<div class="form-check">';
                                            if($relation->id == $column['value']){
                                                echo '<inputs checked class="form-check-inputs" type="radio" value="' . $relation->id . '" name="' . $column['column_name'] . '">';
                                            }else{
                                                echo '<inputs class="form-check-inputs" type="radio" value="' . $relation->id . '" name="' . $column['column_name'] . '">';
                                            }
                                        ...
                                        echo $column['name'] . ' <inputs type="file" name="' . $column['column_name'] . '">';
                                        echo '</label>';
                            ...
                            <a
                                href="{{ route('public/resource.index', $form->id) }}"
                                class="btn btn-primary mt-3"
                            >
                                Return
                            </a>
