          ...
          <div class="animated fadeIn">
            <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                        <div class="card-header" style="text-decoration: underline"><h4>เพิ่มข้อมูลภาษี</h4></div>
                    <div class="card-body">
{{--                        <div class="row">--}}
...
{{--                              </td>--}}
                              ...
                              <td>
                                <a href="{{ url('/inputs/' . $input->id) }}" class="btn btn-block btn-primary"><span class="cil-library-add btn-icon mr-2"></span>เพิ่มข้อมูลภาษี</a>
                              </td>
{{--                              <td>--}}
